...
def get_login_token(session: requests.Session,
                    login_endpoint: str,
                    username: str,
                    password: str) -> str:
    """
    ...
    :param login_endpoint: The login endpoint URL.
...
def get_raw_sdvx_scores(session: requests.Session,
                        scores_endpoint: str,
                        login_token: str) -> dict:
    """
    Get a user's SDVX scores, as returned by the KONAMI API.
    :param session: The existing Requests session.
    :param scores_endpoint: The scores endpoint URL.
